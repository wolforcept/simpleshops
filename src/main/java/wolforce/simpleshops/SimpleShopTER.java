...
import wolforce.simpleshops.utils.UtilClient;
import wolforce.simpleshops.utils.UtilRenderItem;
...
//		final float r22d5 = 0.3926990817f;
		...
		if (barStack != null && !barStack.isEmpty() && barStack.getItem() instanceof StockBarItem) {
			...
			UtilClient.renderImage(matrix, img, 32, 32, // texSize
					3, 7, 10, 2, // xywh
					18, 18, 28, 20, // uvs
					lightLower);
		...
		if (!renderStack.isEmpty()) {
			...
			font.draw(matrix, Util.text("x" + renderStack.getCount()), 0, 0, 0);
